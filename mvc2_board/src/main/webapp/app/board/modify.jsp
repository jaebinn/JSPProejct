		...
		<form id="boardForm" method="post" name="boardForm" action="${cp}/boardupdateok.bo" enctype="multipart/form-data">
			...
			<table border="1">
				<tr>
					<th>제목</th>
					<td>
						<input type="text" name="boardtitle" maxlength="50" value="${board.boardtitle}">
					</td>
				</tr>
				<tr>
					<th>작성자</th>
					...
					<tr class="r${i}">
						...
						<td class="file${i}_cont">
							...
							<div style="float:right; margin-right:100px;">
								<a href="javascript:upload(${i},'${files[i].systemname}')">파일 선택</a>
								<a href="javascript:cancelFile(${i},'${files[i].systemname}')">첨부 삭제</a>
							</div>
				...
				<tr class="r${len}">
					...
					<td class="file${len}_cont">
						...
						<div style="float:right; margin-right:100px;">
							<a href="javascript:upload(${len})">파일 선택</a>
							<a href="javascript:cancelFile(${len})">첨부 삭제</a>
						</div>
					</td>
				</tr>
			</table>
