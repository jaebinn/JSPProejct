...
<html>
<head>
<title>EveryCare-Login/Join</title>
<meta charset="utf-8" />
<meta name="viewport"
	...
	<div id="wrapper">
		...
		<section id="one" class="main alt">
			<header class="accent1">
				<h3>행복을 위한 방법은 많습니다.</h3>
				<h3>우리의 편견으로 그 행복을 제한하지 맙시다.</h3>
				<h3>
					<strong>EveryCare입니다.</strong>
				</h3>
				<div id="btn-wrap">
					<a href="./user-login.jsp"><input type="button" value="로그인"
						id="user-login"></a> <a href="./user-join.jsp"><input
						type="button" value="회원가입" id="user-join"></a>
				</div>
			</header>
