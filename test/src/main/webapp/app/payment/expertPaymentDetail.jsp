...
<body>
   <div class="wrap">
      <div class="top_title">
         <a href="${cp}/getExpertPaymentlist.pm?page="${param.page} class="btn_back" title="이전 화면으로 이동"> <i
         ...
         <a href="${cp}/expertinfo.ep" class="btn_my"> <span title="내 예약">MY</span>
         </a>
      </div>
            ...
            <div class="confirm_top_content">
               ...
               <div class="confirm_item_body">
                  <h3 class="tit_confirm_item">
                     <a href="">
                        <div class="text_confirm_item">
                           <span>유저 연락처</span> <span class="btn_open_card"> <i
                              class="fa-solid fa-chevron-down"></i>
                           </span>
                        </div>
               ...
               <div class="common_bottom_buttongroup_wrap">
                  <div class="common_bottom_buttongroup column2">
                     <a class="common_bottom_btn" href="${cp}/getexpertPaymentlist.pm?page="${param.page}><span>목록으로 돌아가기</span></a>
                  </div>
               </div>
            </div>
         </div>
