...
<html>
						...
						<div class="content primary">
							<form action="${cp}/expertok.ep" method="post" name="expertAddForm" enctype="multipart/form-data">
								<div class="box2">
									...
									<table id="info_box">
										<tr>
											<div id="imgArea" onclick="uploadFile()">
												프로필사진
											</div>
    ...
    var careerTr = document.createElement('tr');
    var newtd1 = document.createElement('td');
    var newtd2 = document.createElement('td');
    var input1 = document.createElement("input");
    input1.setAttribute("type", "text");
    input1.setAttribute("class", "career_name"); // 클래스로 변경
    input1.setAttribute("placeholder", "Ex : 전 근무지명");
    newtd1.innerHTML = "경력사항" + (i + 1);
    newtd2.appendChild(input1);
    careerTr.appendChild(newtd1);
    careerTr.appendChild(newtd2);
    careerTr.classList.add("careerRow");
	...
	function deleteRow() {
	    ...
	    if (careerRow.length > 2) {
	        careerRow[careerRow.length - 1].remove();
	        careerRow[careerRow.length - 2].remove();
	        i--;
	    } else {
	        alert("첫번째 입력란입니다!");
	    }
	...
	function licenseRowAdd() {
	    ...
	    input1.setAttribute("type", "text");
	    input1.setAttribute("class", "license_name"); // 클래스로 변경
	    input1.setAttribute("placeholder", "Ex : 사회복지사");
	    licensetd2.appendChild(input1);
	
	    licensetd3.innerHTML = "취득일자";
	    input2.setAttribute("type", "text");
	    input2.setAttribute("class", "acquire_date"); // 클래스로 변경
	    input2.setAttribute("placeholder", "Ex : 2021.02.21");
	    licensetd4.appendChild(input2);
	...
	function licencRowDelete() {
	    ...
	    if (licenseRow.length > 1) {
	        licenseRow[licenseRow.length - 1].remove();
	        j--;
	    } else {
	        alert("첫번째 입력란입니다!");
	    }
